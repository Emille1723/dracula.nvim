...
--       ['@lsp.type.interface'] = { fg = colors.pink },
      ...
      DiagnosticInfo = { fg = "#89E051", }, -- experimental
      ...
      DiagnosticFloatingInfo = { fg = "#89E051", },
      ...
      DiagnosticVirtualTextInfo = { fg = "#89E051", },
