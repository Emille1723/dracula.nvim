...
--       ['@lsp.type.interface'] = { fg = colors.pink },
      ...
      GitSignsAddCul = { fg = colors.bright_green, bg = colors.transparentWhite },    
      -- GitSignsStagedAddCul = { fg = "#347f4a", bg = colors.cursor },
      GitSignsStagedAddCul = { fg = "#347f4a", bg = colors.transparentWhite },
      ...
      GitSignsChangeCul = { fg = colors.nightfly_yellow, bg = colors.transparentWhite },
      -- GitSignsStagedChangeCul = { fg = "#7f6001", bg = colors.cursor },
      GitSignsStagedChangeCul = { fg = "#7f6001", bg = colors.transparentWhite },
      -- GitSignsStagedChangedeleteCul = { fg = "#7f6001", bg = colors.cursor },
      GitSignsStagedChangedeleteCul = { fg = "#7f6001", bg = colors.transparentWhite },
      GitSignsDelete = { fg = colors.bright_red, },
      -- GitSignsDeleteCul = { fg = colors.bright_red, bg = colors.cursor  },
      GitSignsDeleteCul = { fg = colors.bright_red, bg = colors.transparentWhite },
      -- GitSignsStagedDeleteCul = { fg = "#7f3737", bg = colors.cursor  },
      GitSignsStagedDeleteCul = { fg = "#7f3737", bg = colors.transparentWhite },
      -- GitSignsStagedTopdeleteCul = { fg = "#7f3737", bg = colors.cursor },
      GitSignsStagedTopdeleteCul = { fg = "#7f3737", bg = colors.transparentWhite },
